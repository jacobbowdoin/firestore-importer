...
For an example using abbreviated argument names, to import Chamococo to the dev site, run `firestore-import -d v1-data/chamacoco_export.json -a v1-audio -p v1-photos -i yRl8SvrwmeyckpCHU1X5 -n Chamococo`

Or `firestore-import -d v1-data/photo_test.json -a v1-audio -p v1-photos -i kRlFo5AymRG2hYWg4mpY -n Spanish`
...
Run `gather-pos -s <source>`, for example: `gather-pos -s v1-data/chamacoco_export.json`
